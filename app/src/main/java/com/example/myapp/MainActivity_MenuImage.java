...
public class MainActivity_MenuImage extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
//        Code khởi chạy hệ thống
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_menu_image);
...
//        Code Chính
        ...
        imageView2.setImageResource(R.drawable.f_job_logo);

        //ImageView 3
        ImageView imageView3 = (ImageView) findViewById(R.id.imageView3);
        String url = "https://demoda.vn/wp-content/uploads/2022/02/hinh-thap-eiffel-cua-phap.jpg";
        if (url == null || url.equals("")) {
            Toast.makeText(MainActivity_MenuImage.this, "Error", Toast.LENGTH_LONG).show();
        }
        else {
